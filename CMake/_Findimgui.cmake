...
IF(${APP}_FOUND AND NOT TARGET ${APP})
  ADD_LIBRARY(${APP} INTERFACE IMPORTED)
  ADD_LIBRARY(${APP}::${APP} ALIAS ${APP})
  TARGET_INCLUDE_DIRECTORIES(${APP} INTERFACE "${${APP}_INCLUDE_DIR}")
  SET_TARGET_PROPERTIES(${APP} PROPERTIES IMPORTED_LOCATION "${${APP}_INCLUDE_DIR}")
  SET_TARGET_PROPERTIES(${APP} PROPERTIES IMPORTED_LIBNAME "${APP}")
ENDIF()