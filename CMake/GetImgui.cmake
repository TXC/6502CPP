...
FetchContent_Declare(${IMGUI_NAME}
  ...
  DOWNLOAD_DIR   "${CMAKE_SOURCE_DIR}/includes/${IMGUI_TARGET}"
  SOURCE_DIR     "${CMAKE_SOURCE_DIR}/includes/${IMGUI_TARGET}"
...
CONFIGURE_FILE(
  ...
  "${CMAKE_SOURCE_DIR}/includes/${IMGUI_TARGET}/CMakeLists.txt"
  @ONLY
)
